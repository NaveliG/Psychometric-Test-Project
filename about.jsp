...
<head>
    <title>Recruitment HR Management Category Bootstrap responsive Web Template | About :: w3layouts</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8">
    <meta name="keywords" content="Recruitment a Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="logo">
                            <h1>
                                <a class="navbar-brand" href="index.jsp">
									<i class="fab fa-codepen"></i> Recruitment</a>
                            </h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-lg-auto text-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="how.jsp">How it works</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="services.jsp">Candidates</a>
                                        <a class="dropdown-item" href="candidates_list.jsp" title="">Candidates List 1</a>
                                        <a class="dropdown-item" href="candidates_list.jsp" title="">Candidates List 2</a>
                                        <a class="dropdown-item" href="candidates_list.jsp" title="">Candidates List 3</a>
                                        <a class="dropdown-item" href="candidates_single.jsp" title="">Candidates Single 1</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="employer_list.jsp"> Employer List 1</a>
                                        <a class="dropdown-item" href="employer_list.jsp">Employer List 2</a>
                                        <a class="dropdown-item" href="employer_list.jsp">Employer List 3</a>
                                        <a class="dropdown-item" href="employer_list.jsp">Employer List 4</a>
                                        <a class="dropdown-item" href="employer_single.jsp">Employer Single 1</a>
                                    </div>
                                </li>
                                <li class="nav-item">
            ...
            <div class="inner-sec-w3ls py-md-5 py-3">
                ...
                <div class="row mt-5">
                    <div class="serve-grid col-md-4 col-sm-6 mt-lg-5 text-center">
                        ...
                        <h4 class="my-lg-4 my-3">Resume Evalution</h4>
                        <p>
                        </p>
                    </div>
                    <div class="serve-grid col-md-4 col-sm-6 mt-lg-5 text-center">
                        <i class="far fa-building"></i>
                        <h4 class="my-lg-4 my-3">Test</h4>
                        <p> 
                        </p>
                    </div>
                    <div class="serve-grid col-md-4 col-sm-6 mt-lg-5 text-center">
                        <i class="fas fa-video"></i>
                        <h4 class="my-lg-4 my-3">Student Performance</h4>
                        <p> </p>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="serve-grid col-md-4 col-sm-6 mt-lg-5 text-center">
                        ...
                        <h4 class="my-lg-4 my-3">Pre Placement Activity</h4>
                        <p>                        </p>
                    </div>
    ...
    <footer class="footer-emp-w3layouts bg-dark dotts py-lg-5 py-3">
        <div class="container-fluid px-lg-5 px-3">
            <div class="row footer-top">
                ...
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="pricing.jsp">Job Packages</a>
                        </li>
                        <li>
                    ...
                    <ul class="links">
                        <li>
                            <a href="how.jsp">How it works</a>
                        </li>
                        <li>
                            <a href="contact.jsp">Support</a>
                        </li>
                        <li>
                            <a href="employer_list.jsp">For Employers</a>
                        </li>
                    </ul>
            ...
            <div class="copyright mt-4">
                <p class="copy-right text-center ">&copy; 2018 Recruitment. All Rights Reserved | Design by
